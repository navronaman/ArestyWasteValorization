...
function updateWasteTypeEverywhere() {
    ...
    switch (wasteType) {
        case "food":
            ...
            break;
        case "animal":
            document.getElementById("wastetype-name").innerHTML = "Animal Waste";
            document.getElementById("wastetype-unit").innerHTML = "Animal Waste:";
            document.getElementById("wastetype-units").innerHTML = getDropDownText(1);
            document.getElementById("r0-wastetype").innerHTML = "Animal Waste";
            document.getElementById("m-wastetype").innerHTML = "animal waste";
            document.getElementById("m-wastetype-units").innerHTML = getDropDownText(1);
            break;
    
        case "water":
            document.getElementById("wastetype-name").innerHTML = "Composite Wastewater";
            document.getElementById("wastetype-unit").innerHTML = "Composite Wastewater:";
            document.getElementById("wastetype-units").innerHTML = getDropDownText(2);
            document.getElementById("r0-wastetype").innerHTML = "Composite Wastewater";
            document.getElementById("m-wastetype").innerHTML = "composite wastewater";
...
function displayInfoTop(data){
    ...
    let {mass, electricity, emissions} = reformDataPerUnits(data);
...
function reformDataPerUnits(data){
    // this is where most of the change takes place
    ...
    return {mass, electricity, emissions}; // return the reformatted data
}
